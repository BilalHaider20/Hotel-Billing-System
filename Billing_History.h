...
namespace billingSystemGUI {
	...
	/// Summary for MyForm1
	/// </summary>
	public ref class Billing_History : public System::Windows::Forms::Form
	{
	public:
		Hotel* hotel;
		Billing_History(void)
		{
			InitializeComponent();
		}
		Billing_History(Hotel* hotel)
		{
			InitializeComponent();
			this->hotel = hotel;
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button6->Click += gcnew System::EventHandler(this, &Billing_History::button6_Click);
			// 
			// menuLabel
			// 
			...
			this->label1->Text = L"Orders History";
			// 
			// Billing_History
			// 
			...
			this->Name = L"Billing_History";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"History";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Billing_History::MenuForm_FormClosing);
			this->Load += gcnew System::EventHandler(this, &Billing_History::MenuForm_Load);
